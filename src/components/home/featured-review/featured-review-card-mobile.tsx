		...
		<Link
			...
			<div
				...
				<div className={styles.content}>
					...
					{/* Always mounted so its grid row reserves consistent height; visibility: hidden hides it without collapsing the row, preventing the picker strip below from shifting. */}
					<span
